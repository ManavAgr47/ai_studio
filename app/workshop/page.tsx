          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-8 text-left">
              <motion.div
                ...
                className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full glass-panel text-primary text-xs sm:text-sm font-medium border border-primary/20 bg-primary/5"
              >
              ...
              >
                Master AI-Assisted Software Development with <span className="text-glow text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary">Claude Code</span>
              </motion.h1>
            ...
            <div className="lg:col-span-5 relative w-full flex justify-center items-center">
              <motion.div
                ...
                className="relative w-full max-w-[450px] aspect-square rounded-3xl overflow-hidden glass-panel border border-white/10 p-2 bg-gradient-to-br from-card/85 to-card/25 shadow-2xl group"
              >
                <div className="absolute inset-0 bg-gradient-to-tr from-primary/10 via-transparent to-secondary/15 opacity-50 group-hover:opacity-80 transition-opacity duration-500 rounded-3xl" />
                <img 
                  src="/hero_illustration.png" 
                  alt="AI-assisted software development illustration" 
            ...
            <div className="lg:col-span-7">
              ...
              >
                ...
                <div className="bg-black/40 px-4 py-3 border-b border-white/5 flex items-center justify-between">
                  ...
                  <span className="text-[10px] text-muted-foreground/60">Claude Code terminal simulation</span>
                  <div className="w-14" />
                </div>
